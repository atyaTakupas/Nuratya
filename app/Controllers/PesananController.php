...
class PesananController extends BaseController
{
    ...
    public function store()
    {
        ...
        return redirect()->to('/admin/pesanan')->with('success', 'Pesanan berhasil disimpan.');
    }
    ...
    public function bayar($id)
    {
        ...
        return redirect()->to('admin/pesanan')->with('success', 'Pesanan berhasil dibayar dan status diubah menjadi selesai.');
    }
}