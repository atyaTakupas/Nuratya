...
<div class="container mt-5">
    ...
    <a href="#" class="btn btn-danger mb-3" data-toggle="modal" data-target="#tambahKategoriModal">Tambah Kategori</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= site_url('admin/kategori/delete/' . $k['id_kategori']) ?>" class="btn btn-danger btn-sm"
